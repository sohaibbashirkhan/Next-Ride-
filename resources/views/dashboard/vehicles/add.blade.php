    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 mb-3 d-flex justify-content-between">
                <h4 class="font-weight-bold0 d-flex align-items-center">Add New Vehicle</h4>
                <a href="Vehicle.html" class="btn btn-primary btn-sm d-flex align-items-center justify-content-between">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-9">
                                <form action="{{url('/dashboard/vehicles/store')}}" method="POST"  enctype="multipart/form-data" class="row g-3 date-icon-set-modal">
                                    @csrf
